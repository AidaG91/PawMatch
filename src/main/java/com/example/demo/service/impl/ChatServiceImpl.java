...
public class ChatServiceImpl implements ChatService {
    ...
    @Autowired // para conectarme a la base de datos de chat
    private ChatRepository chatRepository;

    @Autowired // para conectarme a la base de datos de usuario
    ...
    /**
     * Como añadir otro tipo de comentarios:
     * @param id
     * Borro de la base de datos el Chat
     * El Param id hara que al hacer hover sobre deleteChat me dé este texto
     */
    @Override
